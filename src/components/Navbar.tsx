...
const Navbar = () => {
    ...
    const menuVariants = {
        ...
        return (
                <div className="w-full bg-gradient-to-b from-black to-transparent fixed top-0 z-50">
                    <div className="bg-gradient-to-b from-black to-transparent text-white pt-2">
                                ...
                                <ul className="flex flex-row p-4 space-x-8">
                                    ...
                                    <li>
                                        <a href="#contact" className="group">
                                            <h1 className="hidden text-lg font-bold text-white/70 cursor-pointer">Contact Me</h1>
